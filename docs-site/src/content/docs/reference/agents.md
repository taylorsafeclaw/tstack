---
title: Agents
description: Specialized subprocesses with domain knowledge — how they work and how to create them
---
...
See [Extensions](/guides/extensions/) for how project overrides work, and [Install](/getting-started/install/) for how project templates bundle agents together.
...
See [Extensions](/guides/extensions/) for priority resolution.
