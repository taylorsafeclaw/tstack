...
Skills are reusable capability modules that agents and commands can load. They provide domain knowledge, workflows, and reference data without cluttering agent prompts. {% .lead %}
...
The plugin discovers new skills automatically. No extra setup needed.
