    ...
    >
      ...
      <div className="relative flex grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
          <Logomark className="h-9 w-9 text-lime-400 lg:hidden" />
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:grow">
        <Link
          ...
          aria-label="GitHub"
        >
          <GitHubIcon className="h-6 w-6 fill-neutral-500 group-hover:fill-lime-400" />
        </Link>
      </div>
    </header>
  )
    ...
    <div className="flex w-full flex-col">
      ...
      <div className="relative mx-auto flex w-full max-w-8xl flex-auto justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="absolute top-16 right-0 bottom-0 hidden h-12 w-px bg-linear-to-t from-neutral-800 dark:block" />
          <div className="absolute top-28 right-0 bottom-0 hidden w-px bg-neutral-800 dark:block" />
